    ...
    <section id="about" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="text-[#6b5a53] mb-4">Artisan maçon et carreleur avec plus de 18 ans d'expérience dans le Golfe de Saint-Tropez. Nous réalisons des travaux de qualité, du choix des matériaux à la finition.</p>
